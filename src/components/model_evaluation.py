...
class ModelEvaluation:
    ...
    def _map_gender_column(self, df):
        """Map Gender column to 0 for Feamle and 1 for Male."""
        logging.info("Creating 'Gender' column  to binary values")
    ...
    def _rename_columns(self, df):
        ...
        logging.info("Renaming specofic columns and casting to int")
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            if best_model is not None:
                ...
                y_hat_best_model = best_model.prediction(x)
    ...
    def initiate_model_evaluation(self) -> ModelTrainerArtifact:
        ...
        try:
            print("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
            logging.info("Initiatialized Model Evaluation Component.")
            ...
            logging.info(f"Model Evalaution artifact: {model_evaluation_artifact}")
